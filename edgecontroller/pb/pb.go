...
//nolint:lll
//go:generate protoc -I../../schema/pb -I../../../grpc-ecosystem/grpc-gateway -I../../../grpc-ecosystem/grpc-gateway/third_party/googleapis --go_out=plugins=grpc,paths=source_relative,Mela.proto=github.com/otcshare/native-on-prem/edgecontroller/pb/ela:eva ../../schema/pb/eva.proto
