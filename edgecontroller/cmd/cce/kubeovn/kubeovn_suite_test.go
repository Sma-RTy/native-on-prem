...
import (
	...
	authpb "github.com/Sma-RTy/native-on-prem/edgecontroller/pb/auth"
...
func startup() {
	...
	exe, err := gexec.Build("github.com/Sma-RTy/native-on-prem/edgecontroller/cmd/cce")
	...
	exe, err = gexec.Build(
		"github.com/Sma-RTy/native-on-prem/edgecontroller/test/node/grpc")
